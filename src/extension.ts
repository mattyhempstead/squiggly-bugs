...
export function activate(context: vscode.ExtensionContext) {
  ...
  const findBugsDisposable = vscode.commands.registerCommand("squiggly-bugs.findBugs", async () => {
  ...
  const clearBugsDisposable = vscode.commands.registerCommand("squiggly-bugs.clearBugs", () => {
    diagnosticCollection.clear();
    vscode.window.showInformationMessage("Cleared all bug diagnostics");
  });
  ...
  context.subscriptions.push(findBugsDisposable, clearBugsDisposable, saveDisposable);
}
